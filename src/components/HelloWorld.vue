<template>
    <div id="app">
        <div class="reveal">
            <div class="slides">
                <section class="bgimg">
                    <h1 style="text-transform: capitalize; font-size: 72px;">Modellgetriebene Softwareentwicklung?</h1>
                    <p style="font-weight: 700; margin-top: 160px; margin-left: 490px; max-width: 530px;">Firas Mousa &
                        AKM Manjurul Alam
                        <br>
                        zu Herr
                        Hardy
